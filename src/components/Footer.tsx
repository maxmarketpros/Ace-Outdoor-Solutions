                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li>
                                <a href="tel:3462370573" onClick={() => typeof window !== 'undefined' && (window as any).gtag_report_conversion?.('tel:3462370573')} className="text-sm hover:text-white transition-colors flex items-center gap-2">
